...
class CreateTaxiVerificationCodesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('taxi_verification_codes', function (Blueprint $table) {
            $table->id();
            $table->string('email');
    ...
    {
        Schema::dropIfExists('taxi_verification_codes');
    }
}

                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-6 p-5">
                        <div class="col-md-12">
                            ...
                            <h3>Taxi Register Final Step</h3>
                        ...
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    <input type="text" class="form-control" name="vehicle_registration_number" id="vehicle_registration_number" placeholder="Vehicle Registration Number" required>
                                </div>
                                <div class="col-md-4 form-group mt-3 mt-md-0">
                                    <input type="tel" class="form-control" name="vehicle_type" id="vehicle_type" placeholder="Vehicle Model" required>
                                </div>
                                <div class="col-md-4 form-group mt-3 mt-md-0">
                                    <input type="tel" class="form-control" name="vehicle_color" id="vehicle_color" placeholder="Vehicle Color" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 form-group">
